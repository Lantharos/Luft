...
use wayland_server::{
    DataInit, DisplayHandle, Resource, WEnum, backend::ClientId, protocol::wl_surface,
};

use super::{
    SurfaceCachedState, ToplevelConfigure, XdgShellHandler, XdgShellSurfaceUserData,
...
pub fn send_toplevel_configure(
    ...
    let states = {
        let mut states: Vec<xdg_toplevel::State> = configure
            .state
            .states
            .into_filtered_states(resource.version());
