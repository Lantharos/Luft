    ...
    for PointerMoveSurfaceGrab<BackendData>
{
    fn motion(
        ...
        handle: &mut PointerInnerHandle<'_, KestrelState<BackendData>>,
    ...
    fn start_data(&self) -> &PointerGrabStartData<KestrelState<BackendData>> {
        &self.start_data
    }
...
pub struct TouchMoveSurfaceGrab<BackendData: Backend + 'static> {
    pub start_data: TouchGrabStartData<KestrelState<BackendData>>,
    pub window: WindowElement,
    pub initial_window_location: Point<i32, Logical>,
}

impl<BackendData: Backend> TouchGrab<KestrelState<BackendData>>
    for TouchMoveSurfaceGrab<BackendData>
{
    fn down(
        &mut self,
        _data: &mut KestrelState<BackendData>,
        _handle: &mut smithay::input::touch::TouchInnerHandle<'_, KestrelState<BackendData>>,
        _focus: Option<(
            <KestrelState<BackendData> as smithay::input::SeatHandler>::TouchFocus,
            Point<f64, Logical>,
        )>,
    ...
    fn up(
        &mut self,
        data: &mut KestrelState<BackendData>,
        handle: &mut smithay::input::touch::TouchInnerHandle<'_, KestrelState<BackendData>>,
    ...
    fn start_data(&self) -> &smithay::input::touch::GrabStartData<KestrelState<BackendData>> {
        &self.start_data
    }
