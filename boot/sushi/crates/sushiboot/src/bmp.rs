//! Minimal BMP decoder for BGRT boot logos (24-bit, top-down or bottom-up).
...
impl DecodedBmp {
    ...
    pub fn sample_bilinear(&self, u: f32, v: f32) -> (u8, u8, u8) {
        ...
        let x0 = libm::floorf(u) as u32;
        let y0 = libm::floorf(v) as u32;
...
fn lerp_rgb(a: (u8, u8, u8), b: (u8, u8, u8), t: f32) -> (u8, u8, u8) {
    ...
    let inv = 1.0 - t;
    (
        libm::roundf(a.0 as f32 * inv + b.0 as f32 * t) as u8,
        libm::roundf(a.1 as f32 * inv + b.1 as f32 * t) as u8,
        libm::roundf(a.2 as f32 * inv + b.2 as f32 * t) as u8,
    )
}
