//! Shared types for Relay boot continuity.

use bitflags::bitflags;
use serde::{Deserialize, Serialize};
use uuid::Uuid;

pub const RELAY_STATE_VERSION: u32 = 1;

/// Fixed spinner geometry shared across RelayBoot, relayd, and handoffs.
...
pub const RELAY_STATE_PATH: &str = "/run/relay/state";
...
pub const RELAY_LOG_DIR: &str = "/var/log/relay";
pub const RELAY_RUN_DIR: &str = "/run/relay";
...
impl Color {
    ...
    pub const RELAY_ACCENT: Self = Self {
        r: 88,
        g: 166,
        b: 255,
        a: 255,
    ...
    pub const RELAY_TEXT: Self = Self {
        r: 230,
        g: 234,
        b: 242,
        a: 255,
    ...
    pub const RELAY_ERROR: Self = Self {
        r: 255,
        g: 96,
        b: 96,
        a: 255,
...
impl RelayVisualState {
    ...
    pub fn new_boot_scene(width: u32, height: u32) -> Self {
        ...
        Self {
            ...
            boot_id: Uuid::new_v4(),
            stage: RelayStage::Initramfs,
            width,
            height,
            scale: 1.0,
            background: Color::RELAY_BG,
            logo: LogoDescriptor {
...
impl RelayEvent {
    pub fn new(stage: RelayStage, kind: RelayEventKind) -> Self {
        let severity = match &kind {
            RelayEventKind::BootDegraded { .. }
            | RelayEventKind::UnlockManualFailed
            | RelayEventKind::BlackScreenDetected { .. }
            | RelayEventKind::RecoveryEntered { .. } => EventSeverity::Warning,
