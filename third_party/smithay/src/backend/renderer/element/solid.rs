...
impl SolidColorRenderElement {
    ...
    pub fn from_buffer(
        ...
        let geo = Rectangle::new(
            location.into(),
            buffer.size.to_physical_precise_round(scale),
        );
    ...
    pub fn new(
        ...
        let src = Rectangle::from_size(geometry.size)
            ...
            .to_buffer(
                1f64,
                Transform::Normal,
                &geometry.size.to_f64().to_logical(1f64),
            );
    ...
    R: Renderer,
{
    ...
    fn render_elements<C: From<Self::RenderElement>>(
        ...
        vec![
            SolidColorRenderElement::from_buffer(self, location, scale, alpha, Kind::Unspecified)
                .into(),
        ]
    }
}
