...
impl PrivateSurfaceData {
    ...
    pub fn invoke_pre_commit_hooks<D: 'static>(
        state: &mut D,
        dh: &DisplayHandle,
        surface: &WlSurface,
    ) {
    ...
    pub fn invoke_post_commit_hooks<D: 'static>(
        state: &mut D,
        dh: &DisplayHandle,
        surface: &WlSurface,
    ) {
    ...
    pub fn commit<C: CompositorHandler + 'static>(
        surface: &WlSurface,
        dh: &DisplayHandle,
        state: &mut C,
    ) {
    ...
    pub fn set_parent(child: &WlSurface, parent: &WlSurface) -> Result<(), AlreadyHasRole> {
        ...
        // change child's parent
        {
            ...
            if child_guard.public_data.role.is_some()
