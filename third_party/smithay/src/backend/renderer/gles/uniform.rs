...
impl UniformValue {
    ...
    pub unsafe fn set(&self, gl: &super::ffi::Gles2, desc: &UniformDesc) -> Result<(), GlesError> {
        ...
        match self {
            ...
            UniformValue::_4f(v0, v1, v2, v3) => unsafe {
                gl.Uniform4f(desc.location, *v0, *v1, *v2, *v3)
            },
            ...
            UniformValue::_4i(v0, v1, v2, v3) => unsafe {
                gl.Uniform4i(desc.location, *v0, *v1, *v2, *v3)
            },
            ...
            UniformValue::_3ui(v0, v1, v2) => unsafe {
                gl.Uniform3ui(desc.location, *v0, *v1, *v2)
            },
            UniformValue::_4ui(v0, v1, v2, v3) => unsafe {
                gl.Uniform4ui(desc.location, *v0, *v1, *v2, *v3)
            },
