...
impl KeyboardSource {
    ...
    pub fn new_auxiliary() -> Self {
        ...
        KeyboardSource::Auxiliary(
            NEXT_AUX_SOURCE.fetch_add(1, std::sync::atomic::Ordering::Relaxed),
        )
    }
}
...
impl<D: SeatHandler + 'static> KeyboardHandle<D> {
    ...
    pub(crate) fn new(
        ...
        let internal = KbdInternal::new(xkb_config, repeat_rate, repeat_delay, context_flags)
            .map_err(|_| {
