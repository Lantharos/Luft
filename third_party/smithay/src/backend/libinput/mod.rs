...
impl backend::GestureSwipeBeginEvent<LibinputInputBackend>
    for event::gesture::GestureSwipeBeginEvent
{
}
...
impl backend::GestureSwipeUpdateEvent<LibinputInputBackend>
    for event::gesture::GestureSwipeUpdateEvent
{
    fn delta_x(&self) -> f64 {
...
impl backend::GesturePinchBeginEvent<LibinputInputBackend>
    for event::gesture::GesturePinchBeginEvent
{
}
...
impl backend::GesturePinchUpdateEvent<LibinputInputBackend>
    for event::gesture::GesturePinchUpdateEvent
{
    fn delta_x(&self) -> f64 {
        event::gesture::GestureEventCoordinates::dx(self)
    }
...
impl backend::GestureHoldBeginEvent<LibinputInputBackend>
    for event::gesture::GestureHoldBeginEvent
{
}
            ...
            for event in &mut self.context {
                match event {
                    ...
                    libinput::Event::Gesture(gesture_event) => match gesture_event {
                        event::GestureEvent::Swipe(event::gesture::GestureSwipeEvent::Begin(
                            event,
                        )) => {
                            callback(InputEvent::GestureSwipeBegin { event }, &mut ());
                        }
                        event::GestureEvent::Swipe(event::gesture::GestureSwipeEvent::Update(
                            event,
                        )) => {
                            callback(InputEvent::GestureSwipeUpdate { event }, &mut ());
                        }
                        event::GestureEvent::Swipe(event::gesture::GestureSwipeEvent::End(
                            event,
                        )) => {
                            callback(InputEvent::GestureSwipeEnd { event }, &mut ());
                        }
                        event::GestureEvent::Pinch(event::gesture::GesturePinchEvent::Begin(
                            event,
                        )) => {
                            callback(InputEvent::GesturePinchBegin { event }, &mut ());
                        }
                        event::GestureEvent::Pinch(event::gesture::GesturePinchEvent::Update(
                            event,
                        )) => {
                            callback(InputEvent::GesturePinchUpdate { event }, &mut ());
                        }
                        event::GestureEvent::Pinch(event::gesture::GesturePinchEvent::End(
                            event,
                        )) => {
                            callback(InputEvent::GesturePinchEnd { event }, &mut ());
                        }
                        event::GestureEvent::Hold(event::gesture::GestureHoldEvent::Begin(
                            event,
                        )) => {
