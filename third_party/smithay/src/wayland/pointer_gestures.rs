...
use crate::{
    input::{
        ...
        pointer::{
            ...
            GestureSwipeEndEvent, GestureSwipeUpdateEvent, PointerHandle,
        },
    },
...
impl WpPointerGesturePointerHandle {
    ...
    fn for_each_focused_hold_gesture(
        &self,
        surface: &WlSurface,
...
impl PointerGesturesState {
    ...
    {
        let global =
            display.create_global::<D, ZwpPointerGesturesV1, _>(MANAGER_VERSION, GlobalData);
