    ...
    fn eq(&self, other: &Self) -> bool {
        self.namespace == other.namespace
            && match (&self.inner, &other.inner) {
                ...
                (InnerId::External(this_id), InnerId::External(other_id)) => {
                    Arc::ptr_eq(this_id, other_id)
                }
    ...
    fn eq(&self, other: &Self) -> bool {
        self.namespace == other.namespace
            && match (&self.inner, &other.inner) {
                #[cfg(feature = "wayland_frontend")]
                (
                    InnerWeakId::WaylandResource(this_obj),
                    InnerWeakId::WaylandResource(other_obj),
                ) => this_obj == other_obj,
