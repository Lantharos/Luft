use crate::backend::input::{
    self as backend, TabletToolCapabilities, TabletToolDescriptor, TabletToolTipState,
    TabletToolType,
};
...
impl backend::TabletToolProximityEvent<LibinputInputBackend>
    for tablet_tool::TabletToolProximityEvent
{
