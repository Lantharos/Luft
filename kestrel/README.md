...
- The launcher uses the original two-part Luft mark at the same 24px size as app icons, with its original resting proportions and opposing hover motion. Taskbar apps slide and fade in and out while their space expands or closes. Search has a text-aligned caret that blinks while focused; running dots sit beneath app icons.
