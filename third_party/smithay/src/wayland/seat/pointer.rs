...
use wayland_server::{
    ...
    protocol::{
        wl_pointer::{
            self, Axis as WlAxis, AxisSource as WlAxisSource, ButtonState as WlButtonState,
            Request, WlPointer,
        },
            ...
            if details.axis.1 != 0.0 {
                if ptr.version() >= 9 {
                    ptr.axis_relative_direction(
                        ...
                        details.relative_direction.1.into(),
                    );
                }
                ptr.axis(
                    details.time,
