...
pub struct PointerHandle<D: SeatHandler> {
    ...
    #[cfg(feature = "wayland_frontend")]
    pub(crate) wp_pointer_gestures:
        Arc<crate::wayland::pointer_gestures::WpPointerGesturePointerHandle>,
    #[cfg(feature = "wayland_frontend")]
...
impl<D: SeatHandler + 'static> PointerHandle<D> {
    pub(crate) fn new() -> PointerHandle<D> {
        PointerHandle {
            ...
            #[cfg(feature = "wayland_frontend")]
            wp_relative: Arc::new(
                crate::wayland::relative_pointer::WpRelativePointerHandle::default(),
            ),
...
impl<D: SeatHandler + 'static> PointerInternal<D> {
        ...
        F: FnOnce(&mut D, &mut PointerInnerHandle<'_, D>, &mut dyn PointerGrab<D>),
    {
        ...
        match grab {
            GrabStatus::Borrowed => {
                panic!("Accessed a pointer grab from within a pointer grab access.")
            }
