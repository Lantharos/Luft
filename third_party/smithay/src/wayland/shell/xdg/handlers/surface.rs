...
use wayland_protocols::{
    ...
    xdg::shell::server::{
        xdg_popup::XdgPopup, xdg_surface, xdg_surface::XdgSurface, xdg_toplevel::XdgToplevel,
        xdg_wm_base,
    },
};
            ...
            xdg_surface::Request::GetToplevel { id } => {
                ...
                let initial = compositor::with_states(surface, |states| {
                    ...
                    let current_capabilities =
                        &mut attributes.server_pending.as_mut().unwrap().capabilities;
            ...
            xdg_surface::Request::SetWindowGeometry {
                ...
                compositor::with_states(surface, |states| {
                    states
                        ...
                        .pending()
                        .geometry = Some(Rectangle::new((x, y).into(), (width, height).into()));
                });
            }
